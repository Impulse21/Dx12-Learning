...
float4 main(VSOutput input) : SV_TARGET
{
    ...
    float3 halfwayDir = normalize(DirectionLightCB.Direction + input.viewDirWS);
    
    float specularIntensity = pow(saturate(dot(normalWS, halfwayDir)), MaterialCB.Shininess);
