...
#include "Shaders/Generated/PanoToCubemapCS_generated.h"
...
PanoToCubemapPso::PanoToCubemapPso(std::shared_ptr<Dx12RenderDevice> renderDevice)
	...
	, m_rootSignature(renderDevice)
{
    ...
    pipelineStateStream.CS = { gPanoToCubemapCS, sizeof(gPanoToCubemapCS) };
    ...
    // Alocate Descriptors
    this->m_defaultUAV = this->m_renderDevice->AllocateDescriptors(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 5);
