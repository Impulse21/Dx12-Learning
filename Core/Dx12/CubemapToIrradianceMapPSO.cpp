...
#include "Shaders/Generated/CubemapToIrradianceMapCS_generated.h"
...
CubemapToIrradianceMapPso::CubemapToIrradianceMapPso(std::shared_ptr<Dx12RenderDevice> renderDevice)
	...
	, m_rootSignature(renderDevice)
{
    ...
    rootParameters[CubemapToIrradianceMapRS::SrcTexture].InitAsDescriptorTable(1, &srcMip);
    rootParameters[CubemapToIrradianceMapRS::OutputTexture].InitAsDescriptorTable(1, &outMip);
    ...
    pipelineStateStream.CS = { gCubemapToIrradianceMapCS, sizeof(gCubemapToIrradianceMapCS) };
